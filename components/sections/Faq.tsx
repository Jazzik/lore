...
// ДЕМО-ДАННЫЕ. Конкретика в ответах (минимальный тираж, размер аудитории,
// сроки) вымышлена для превью. Юридически значимые пункты — выплаты, брак,
// права на бренд — намеренно отвечают процессом, а не выдуманным числом.
